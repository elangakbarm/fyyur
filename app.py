...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres+psycopg2://postgres:elang12@localhost:5432/fyyur'
db = SQLAlchemy(app)
moment = Moment(app)
...
class Venue(db.Model):
    ...
    def __init__(self, name, genres, address, city, state, phone,facebook_link,
                 seeking_talent=False, seeking_description="",
                 image_link="/src/img/music-note.jpg"):
        self.name = name
        self.genres = genres
